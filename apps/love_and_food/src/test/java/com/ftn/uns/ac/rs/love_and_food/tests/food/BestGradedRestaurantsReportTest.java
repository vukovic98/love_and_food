...
public class BestGradedRestaurantsReportTest {
	...
	public void setUp() throws ParseException {
		...
		kieSession.getAgenda().getAgendaGroup("best-graded-report").setFocus();
	}

	@Test
	public void getBestGradedRestaurant() {
		...
		assertEquals(2, bestGraded.size());
		assertEquals(1L, bestGraded.get(0).getRestaurant_id());
		assertEquals(2L, bestGraded.get(1).getRestaurant_id());
	}
