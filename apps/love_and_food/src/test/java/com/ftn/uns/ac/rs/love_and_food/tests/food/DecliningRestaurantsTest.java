...
public class DecliningRestaurantsTest {
	...
	public void setUp() throws ParseException {
		...
		kieSession.getAgenda().getAgendaGroup("declining-rating").setFocus();
	}
	...
	public void getDecliningRestaurants() {
		...
		assertEquals(1, decliningRestaurants.size());
		assertEquals(2L, decliningRestaurants.get(0).getRestaurant_id());
	}
