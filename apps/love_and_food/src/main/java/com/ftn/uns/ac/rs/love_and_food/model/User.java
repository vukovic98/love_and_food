...
public class User extends RegisteredUser{
	...
	public User(String email, String password, String name, String surname, Date dateOfBirth, double income, 
			Gender gender, SexualOrientation sexualOrientation, Education education, Religion religion, Children children,
